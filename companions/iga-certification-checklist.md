...
- [ ] Each certifier will see, per item: what the entitlement does, when it was last used, the justification on record
...
- [ ] Campaign quality signals reviewed: approval rate, median decision time per item, bulk approval count
- [ ] Signals reported on the fixed reporting cycle as risk movement, alongside completion

*Reading the quality signals: approval rates approaching one hundred percent with decision times of seconds per item are the observable signal of rubber-stamping (chapter 5, F3). Completion percentage alone reports activity, and the mandate reports risk (chapter 1, M2).*
